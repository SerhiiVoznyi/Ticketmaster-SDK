namespace Ticketmaster.Discovery.Tests.V2.ClientTests
{
    ...
    public class GetClassificationDetailsMethodTests : MethodTest
    {
        ...
        {
            IRestResponse result = await _sut.CallGetClassificationDetailsAsync(new GetRequest(""));
        ...
        {
            Classification result = await _sut.GetClassificationDetailsAsync(new GetRequest(""));
